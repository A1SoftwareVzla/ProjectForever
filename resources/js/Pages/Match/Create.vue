    ...
    <AppLayout :auth="auth">
        <div class="space-y-6">
            <div class="flex justify-between items-center">
                <h1 class="text-3xl font-bold text-primary">Crear Partido</h1>
            </div>
            ...
            <Card class="p-6 max-w-2xl">
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div>
                        <label for="result" class="block text-sm font-medium mb-2">Resultado (Opcional)</label>
                        <input
                            id="result"
                            v-model="form.result"
                            type="text"
                    ...
                    <div class="flex gap-2 pt-4">
                        <Button type="submit" :disabled="form.processing">
                            {{ form.processing ? 'Guardando...' : 'Guardar Partido' }}
                        </Button>
