...
<div class="row">
    ...
    <div class="card">
        ...
        <span class="card-title">Listado de fechas <a href="{{route('admin')}}" class="waves-effect waves-light btn orange darken-1"><i class="material-icons left">reply</i>Menú principal</a></span>         
        <div class="row">
            <div class="col s12">                                 
